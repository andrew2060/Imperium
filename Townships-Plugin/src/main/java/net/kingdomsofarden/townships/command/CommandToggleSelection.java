...
public class CommandToggleSelection implements Command, Listener {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        Messaging.sendFormattedMessage(sender, val ? I18N.SELECTION_ENABLED : I18N.SELECTION_DISABLED);
        return true;
    }
    ...
    public void onPlayerInteract(PlayerInteractEvent event) {
        ...
        if (cache.getOrDefault(pid, false)) {
            ...
            if (a == Action.RIGHT_CLICK_BLOCK || a == Action.LEFT_CLICK_BLOCK) {
                ...
                Messaging.sendFormattedMessage(event.getPlayer(),
                        I18N.SELECTION_SET, type, loc.getBlockX(), loc.getBlockY(), loc.getBlockZ());
            }
